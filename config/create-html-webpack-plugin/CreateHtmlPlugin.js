...
//             // 所有需要输出的资源会存放在 compilation.assets中，compilation.assets是一个键值对，
//             // 键为需要输出的文件名称，值为文件对应的内容。
//             // 取到生成的静态文件路径
//             let assetsList = Object.keys(stat.compilation.assets); // 需要输出得文件名

//             assetsList.map((item) => {
//                 // 解析路径信息成一个对象
//                 // 返回路径各部分的信息 为一个对象。如：'/home/user/dir/file.txt'， 
